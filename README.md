...
- **Event registration — auto step 2:** On load, the first available event (or `?event=` preset) is auto-selected and the wizard advances to **Personal Info**; users can still go Back to change the event.
