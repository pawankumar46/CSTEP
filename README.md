...
- **Event registration — ICAS dates:** Step 3 (Select Days) now hides **19 Aug 2026** for ICAS events; delegates can register only for **20 Aug** and **21 Aug**. Event-day labels use the API `date` field formatted as **20th August** (not backend labels like “Day 1”).
